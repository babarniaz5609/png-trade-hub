...
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO public.profiles (id, email, username, role, kyc_status)
  VALUES (
    new.id, 
    new.email, 
  ...
  INSERT INTO public.wallets (user_id, currency, network, available_balance, locked_escrow_balance)
  VALUES 
    (new.id, 'USDT', 'TRC20', 0, 0),
    (new.id, 'PGK', 'BANK', 0, 0);
